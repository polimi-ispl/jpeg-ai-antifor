"""
Small script using the src.reco.coders.encoder module to encode and decode the FFHQ dataset.
...
def process_dir_with_encoder(coder: RecoEncoder, input_dir: str, save_dir: str):
    ...
    image_files = pd.read_csv(input_csv)

    # Create save directories
    save_dir = os.path.join(save_dir, 'compressed', f"target_bpp_{kwargs['set_target_bpp']}")
    ...
    if kwargs['num_samples'] is not None:
        image_files = image_files.sample(frac=1, random_state=42)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--models_dir_name', type=str, default='../models', help='Directory name for the '
                                                                                 ...
                                                                                 'pipeline')
    parser.add_argument('--input_csv', type=str, default='/nas/public/exchange/JPEG-AI/data/TEST_FFHQ/ffhq_paths.csv',)
